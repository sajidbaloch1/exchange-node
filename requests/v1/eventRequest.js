...
async function eventListingRequest(req) {
  ...
  req.body.sportId = req.body?.sportId ? req.body.sportId?.trim() : null;
  req.body.competitionId = req.body?.competitionId ? req.body.competitionId?.trim() : null;
  req.body.status = req.body?.status ? req.body.status?.trim() : null;
